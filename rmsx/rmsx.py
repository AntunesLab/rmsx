...
# to do, allow option to select color of chart in viridis for all
# update code to avoid the warnings abour depreciation
...
def create_r_plot(
    ...
    try:
        # Determine the directory of the current script or use current working directory
        try:
            current_dir = Path(__file__).parent.resolve()
        except NameError:
            # __file__ is not defined in some environments like Google Colab
